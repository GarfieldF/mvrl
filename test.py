...
def run(env, vl_policy , policy_path, action_bound, optimizer):
    ...
    for id in range(MAX_EPISODES):
        ...
        while not rospy.is_shutdown():
            ...
            total_speed +=speed[0]
            state_next = [obs_bottom_left, obs_bottom_central, obs_bottom_right, speed, commond_next]
...
if __name__ == '__main__':
    ...
    vl_policy_path = '/home/nvidia/multicamerarl/bottom_policy_models' # 'vl_models_no_car_and_person_best'-->1360       'vl_models'-->1200
    ...
    vl_file = vl_policy_path + '/stage1_2460 episode_2516'    #stage1_2460 episode_2516    '/Stage1_7500'   #1460  1200 1040 660 620 600 560 500
    ...
    command1 = '/home/nvidia/multicamerarl/command/model_struct.json'
    command_weights = '/home/nvidia/multicamerarl/command/weights_006.h5'
    command_policy = jsonToModel(command1)
    command_policy.load_weights(command_weights)
    ...
    env = CarlaEnv1(index=0, bottom_policy=bottom_policy,command_net = command_policy)
